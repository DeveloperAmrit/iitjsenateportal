  ...
  return (
    <>
      <style>{`
        ...
        /* Global styles - typically in index.css or a global stylesheet */
        * {
          margin: 0;
          padding: 0;
        ...
        .banner .content .model {
          background-image: url(images/model.png); /* Adjust path as needed */
          width: 100%;
          height: 75vh;
          position: absolute;
          bottom: 0;
      ...
      <div className="banner">
        <div className="slider" style={{ '--quantity': 10 } as React.CSSProperties}>
          {Array.from({ length: 10 }).map((_, index) => (
            ...
            >
              <img src={`images/dragon_${index + 1}.jpg`} alt="" />
            </div>
          ))}
        </div>
